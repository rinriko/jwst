            ...
            for rOut in range(30, 35, 10):
                ...
                if rOut > rIn:
                    ...
                    for x in range(len(fileList)):
                        ...
                        # -------------------------------------------------------------
                        meandata = np.nanmean(original_data, axis=0)
                    ...
                    ap_result.write(
                        f"T:\JWST-Timing\jwst\output_with_Corrupt_Origin\Shaw_ZTF_J1539_photometry.CorruptAndOriginCentroid.{epoch}.{wave_type}.{r_in}.{r_out}.hdf5",
                        overwrite=True, serialize_meta=True, path="aperture"
                    )
                    psf_result.write(
                        f"T:\JWST-Timing\jwst\output_with_Corrupt_Origin\Shaw_ZTF_J1539_photometry.CorruptAndOriginCentroid.{epoch}.{wave_type}.{r_in}.{r_out}.hdf5",
