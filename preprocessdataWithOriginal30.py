            ...
            for rOut in range(30, 35, 10):
                ...
                if rOut > rIn:
                    ...
                    for x in range(len(fileList)):
                        ...
                        meandata = np.nanmean(original_data[valid_indices], axis=0)
                    ...
                    ap_result.write(
                        f"T:\JWST-Timing\jwst\output_with_AfterJay_Original30\Shaw_ZTF_J1539_photometry.AfterJayAndOriginalCentroid.{epoch}.{wave_type}.{r_in}.{r_out}.hdf5",
...
centroid_csv_path = r"T:\JWST-Timing\jwst\output_with_AfterJay_Original30\centroid_log.csv"
