...
HDF5_DIR = Path(r"T:\JWST-Timing\jwst\output_with_exclude")
...
def write_to_json_by_folder(final, base_prefix='ZTF_J1539_WITH_EXCLUDE'):
    for excl_label, bucket in final.items():
        # e.g. ZTF_J1539_WITH_EXCLUDE_outlier_sigma3
...
write_to_json_by_folder(final, base_prefix='ZTF_J1539_WITH_EXCLUDE')