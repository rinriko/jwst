        ...
        for rIn in range(10, 12, 4):
            ...
            for rOut in range(30, 35, 10):
                ...
                if rOut > rIn:
                    ...
                    ap_result.write(
                        f"T:\JWST-Timing\jwst\output_with_Corrupt_Recalculated\Shaw_ZTF_J1539_photometry.CorruptAndRecalculatedCentroid.{epoch}.{wave_type}.{r_in}.{r_out}.hdf5",
...
centroid_csv_path = r"T:\JWST-Timing\jwst\output_with_Corrupt_Recalculated\centroid_log.csv"
